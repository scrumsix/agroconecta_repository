...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Se mantienen los estilos originales de Laravel para la estructura --}}
    ...
    <body class="font-sans antialiased">
        <div class="bg-gray-50 text-black/50">
            {{-- Puedes cambiar la imagen de fondo si quieres, o quitarla --}}
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" alt="Agroconecta background" />
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            {{-- Logo de Agroconecta (texto) --}}
                            <h1 class="text-2xl font-bold" style="color: #2d8a4a;">Agroconecta</h1>
                        </div>
                        @if (Route::has('login'))
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Del Campo a tu Mesa en Bogotá</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Agroconecta es el puente directo entre los campesinos de la región y tu hogar en Bogotá. Recibe productos frescos, cosechados con dedicación, apoyando el comercio local y garantizando precios justos para todos.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    ...
                                    <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#FF2D20">
                                        <path d="M19.261 5.955c-1.63 0-2.952-1.323-2.952-2.952S17.63 0 19.261 0s2.952 1.323 2.952 2.952-1.323 3.003-2.952 3.003zm-7.06 9.208c-2.31 0-4.183-1.873-4.183-4.183s1.873-4.183 4.183-4.183 4.183 1.873 4.183 4.183-1.873 4.183-4.183 4.183zm.048 1.488c2.17 0 3.929-1.759 3.929-3.929S14.377 8.8 12.25 8.8s-3.929 1.759-3.929 3.929 1.759 3.929 3.929 3.929zM12.202 24c-3.722 0-6.739-3.017-6.739-6.739S8.48 10.522 12.202 10.522s6.739 3.017 6.739 6.739S15.924 24 12.202 24zm0-12c-2.915 0-5.281 2.366-5.281 5.281s2.366 5.281 5.281 5.281 5.281-2.366 5.281-5.281-2.366-5.281-5.281-5.281z"/>
                                    </svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Nuestros Productos</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Explora una gran variedad de frutas, verduras y hortalizas frescas. Cada producto cuenta la historia de la tierra y las manos que lo cultivaron en la sabana de Bogotá. Calidad y sabor que solo el campo puede ofrecer.
                                    </p>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    {{-- Icono de campesino --}}
                                    <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="#FF2D20" viewBox="0 0 24 24">
                                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                                    </svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">¿Eres Campesino? Únete</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Si eres un productor local en la región de Bogotá, te invitamos a formar parte de nuestra comunidad. Ofrece tus productos directamente al consumidor, obtén un pago justo por tu trabajo y ayúdanos a llevar lo mejor del campo a la ciudad.
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Comercio con Precios Justos</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Creemos en un modelo sostenible. Al eliminar intermediarios innecesarios, nos aseguramos de que los campesinos reciban una compensación justa por su arduo trabajo y que tú pagues un precio razonable por productos de alta calidad.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <footer class="py-16 text-center text-sm text-black">
                        Agroconecta &copy; 2025 - Conectando el campo y la ciudad en Bogotá.
                    </footer>
                </div>
            </div>
        </div>
